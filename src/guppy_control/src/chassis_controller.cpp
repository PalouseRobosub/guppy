...
void ChassisController::update_parameters(ChassisControllerParams parameters) {
  ...
  this->velocity_pid[2].set_gains(-1 * params_.pid_gains_vel_linear[0], params_.pid_gains_vel_linear[1], params_.pid_gains_vel_linear[2], std::numeric_limits<double>::infinity(), -std::numeric_limits<double>::infinity(), antiwindup_strat);
