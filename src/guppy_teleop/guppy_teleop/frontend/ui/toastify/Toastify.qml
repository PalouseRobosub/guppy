...
Item {
    ...
    function createMessage(message, options = {}) {
        try {
            ...
            var component = Qt.createComponent("qrc:/toastify/ui/toastify/ToastifyDelegate.qml")
            var messageContainer = component.createObject(determinePosition(position), {
                message, type, position, theme, closeOnClick, autoClose, hideProgressBar, clickAction
                });
